      ...
      >
        ...
        {menuOpen && (
          <div className="md:hidden px-4 py-3 flex flex-col gap-0.5"
            ...
            <Link href="/tarot" onClick={() => setMenuOpen(false)} className="px-2 py-2.5 rounded hover:bg-white/5" style={{ color: pathname === "/tarot" ? "var(--text)" : "var(--text-muted)", fontWeight: pathname === "/tarot" ? 600 : 400, fontSize: 14, textTransform: "uppercase", letterSpacing: "0.05em", textDecoration: "none" }}>✦ ดูดวงไพ่ยิปซี</Link>
